...
import LineItem from './ComposantList'
      ...
      <form>
        ...
        <div className={styles.lineItems}>
                        ...
                        {(provided, snapshot) => (
                          ...
                          >
                            <LineItem
                              ...
                              categorie={item.categorie} quantite={item.quantite} prixht={item.prixht}
                              {...functions}
                            />
                          </div>
                        )}
          ...
          <div className={styles.addItem}>
            <button type="button" onClick={addHandler}><AddIcon size="1.25em" className={styles.addIcon} />Ajouter composant</button>
          </div>
